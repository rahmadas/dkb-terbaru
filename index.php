...
<style>
  ...
  <body>
   ...
   <!-- Header
   ================================================== -->
   <header id="home" style="background: #161415 url('bg/wayang.jpg') no-repeat top center;">
      ...
      <nav id="nav-wrap">
         ...
         <ul id="nav" class="nav">
            ...
            <li><a class="smoothscroll" href="#testimonials">Berita</a></li>
            <li><a class="smoothscroll" href="#clients">Pengurus</a></li>
           <li><a class="smoothscroll" href="#resume">Refrensi</a></li>
...
?>
   ...
   <section id="about" style="background:#f7f7f7 !important">
      ...
      <div class="row">
         ...
         <div class="three columns">
            ...
            <img class="profile-pic"  src="bg/favicon.jpeg" alt="" />
   ...
   <section id="contact_us">
      <div class="d-flex">
         ...
         <div class="col-lg-12">
            <h4 class="text-center text-light">Kontak </h4>
               <div class="d-flex">
                  <div class="col-lg-6">
                     <div class="form-group">
                        <label for="full_name" class="control-label text-light">Nama Lengkap</label>
               ...
               <div>
                  <h2 class="text-light">Kontak Lengkap</h2>
                  <p class="address">
